...
// <li className={`mx-2 ${contactSelected && 'navActive'}`}> --> if the value of contactSelected is true, which means that the user selected Contact, we want to add the CSS class navActive, which will illuminate the background
